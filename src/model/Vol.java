...
public class Vol implements Component {
    ...
    public void afegirTripulant(Tripulant tripulant) {
        ...
        //Si el tripulant creat és de tipus TCP, aleshores, com només pot haver un cap de cabina de passatgers, li demanrem a l'usuari si el tripulant ha de ser cap de cabina
        if (tripulant instanceof TCP) {
            if (String.valueOf(demanarDades("\nVols que el tripulant afegit sigui cap de cabina?: S-Si o N-No", 2)).equals("S")) {
                cap.setRang(null);
                cap = (TCP) tripulacio.get(tripulant.getPassaport());
                cap.setRang("cap");
            }
        }
    ...
    public void mostrarComponent() {
        ...
        Iterator punter=tripulacio.keySet().iterator();
        Object passaport;
        ...
        while(punter.hasNext()){
            ...
            passaport=punter.next();
            
            if ( tripulacio.get(passaport)!= null && tripulacio.get(passaport) instanceof TripulantCabina) {
                tripulacio.get(passaport).mostrarComponent();
            }
        }
        ...
        System.out.println("\nLa tripulació de cabina de passatgers és:");
         ...
         while(punter.hasNext()){
            ...
            if ( tripulacio.get(passaport)!= null && tripulacio.get(passaport) instanceof TCP) {
                tripulacio.get(passaport).mostrarComponent();
            }
        }
