...
public class GestioVolsExcepcio extends Exception {
    ...
    public GestioVolsExcepcio(String pCodiCausa) {
        ...
        switch (codiCausa) {
            ...
            case "GestorJDBC.noExisteix":
                missatge = "La companyia no existeix a la base de dades";
                break;
            default:
    ...
    public static boolean comprovarCodiAvio(String codi) {
        return Pattern.compile("^[0-9]{3}$").matcher(codi).find();
    }
    ...
    public static boolean comprovarCodiVol(String codi) {
        return Pattern.compile("^[a-zA-Z]{2,3}[0-9]{4}$").matcher(codi).find();
    }
    ...
    public String getMessage() {
        return "La excepcio amb codi " + codiCausa + " és: " + missatge;
    }
